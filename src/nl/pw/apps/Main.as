package nl.pw.apps
{
	...
	public class Main extends Sprite
	{
		...
		{
			var filePath:String = "assets/launch-images/";
			...
			if(filePath)
			{
				...
				if(file.exists)
				{
					...
					if(isPortraitOnly)
					{
						...
						trace("launch image file does not exist, probably Android");
					}
			}
		}
		...
		{
			//First initialize Flox to make sure we have backend analytics
			_settings = Settings.getInstance();
			Flox.init(_settings.floxGameID, _settings.floxGameKey, _settings.floxGameVersion);
			
			//Then start starling
			Starling.multitouchEnabled = true;
			this._starling = new Starling(Game, this.stage, null, null, Context3DRenderMode.AUTO, Context3DProfile.BASELINE);
