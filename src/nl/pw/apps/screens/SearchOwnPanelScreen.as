package nl.pw.apps.screens{
	...
	public class SearchOwnPanelScreen extends PanelScreen
	{
		public static const SHOW_SETTINGS:String = "showSettings";
		public static const SHOW_BOOK_DETAILS:String = "showBookDetails";

		public function SearchOwnPanelScreen()
		{
			super();
		}
		...
		override protected function initialize():void
		{
			...
			this._list.dataProvider = new HierarchicalCollection(this._model.searchOwnBooks);
			...
			this._list.itemRendererFactory = function():IGroupedListItemRenderer
			{
				...
				renderer.accessoryLabelField = "subtitle";
